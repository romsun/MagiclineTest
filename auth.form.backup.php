...
<div id="authformdiv" data-role="content" style="width:700px">
<?php
//        if($receiver =="9999" AND $phone != ""){ echo ""; exit; exit; }elseif($phone == "") {
        echo ""
        ."<div style='width:900px;' onMouseOver='parent.removeWelcome(); parent.offkan()' onClick='parent.removeWelcome()'>"
